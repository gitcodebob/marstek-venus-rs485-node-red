...
## 4.8.0
- **Feat: Auto balance battery priority cycle — fixes #114**
  ...
  * Daily and Weekly cycle options now only trigger at 02:00, preventing unintended mid-cycle rotations.
  * Thanks to _sjoerd-creator_ for the feature request and suggested implementation.
